...
const { GetTotalCars, CapitalStuck, GetUniqueModels, GetUniqueVariants, GetAgeBuckets,GetLastUpdateDate,GetAges, GetAllStocks, GetStockStatusHeader } = require('../controller/InventoryData.controller')
const router = express.Router()

router.get('/GettotalCars/:dealer_id/:order_dealer/:stock_status',GetTotalCars)
router.get('/CapitalStuck/:dealer_id/:order_dealer/:stock_status',CapitalStuck)
